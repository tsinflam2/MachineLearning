...
def draw_line_chart(ticker, options):
    original, logis_forecast_set, logis_confidence = logistic_model.train(ticker)
    # print(original)
    # print(logis_forecast_set)
    # print(logis_confidence)
    ...
    return logis_confidence, str(logis_forecast_set)
